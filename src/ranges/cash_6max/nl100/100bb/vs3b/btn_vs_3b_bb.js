// BTN vs 3b BB (6-max, 100bb)
// Paste your GTO ranges under each pfr size below.
export default {
  name: "BTN vs 3b BB",
  description: "BTN faces 3-bet from BB — 6-max, 100bb",
  pfrSizes: {
    '2bb': {
      raise: {
        '26bb': "",
