...
function openSize(opener) {
  ...
  if (t) return t
  // Fallback heuristic: scale from 100bb defaults assuming similar shape
...
/**
 * Generate every (RFI, vs-RFI, vs-3B) spot for 8-max MTT.
 ...
 * All other stacks in the user's spec are accessible.
 */
export const STACK_SIZES = [100, 80, 70, 60, 55, 50, 45, 40, 38, 35, 32, 30, 28, 26, 25, 22, 20, 10]
